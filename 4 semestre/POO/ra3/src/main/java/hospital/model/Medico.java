...
public class Medico extends Funcionario {
    ...
    public Medico(String nome, String endereco, LocalDate dataNascimento,
        ...
        this.crm = crm;
        if (this.crm.trim().isEmpty()) throw new IllegalArgumentException("crm inválido");
        if (especialidade == null) throw new NullPointerException("especialidade não pode ser nula");
        this.especialidade = especialidade;
        if (this.especialidade.trim().isEmpty()) throw new IllegalArgumentException("especialidade inválida");
    ...
    public void setCrm(String crm) { if (crm == null) throw new NullPointerException("crm não pode ser nulo"); this.crm = crm; }

    public String getEspecialidade() { return especialidade; }
    public void setEspecialidade(String especialidade) { if (especialidade == null) throw new NullPointerException("especialidade não pode ser nula"); this.especialidade = especialidade; }
