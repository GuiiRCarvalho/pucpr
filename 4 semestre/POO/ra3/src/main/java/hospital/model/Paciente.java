...
public class Paciente extends Pessoa {
    ...
    public Paciente(String nome, String endereco, LocalDate dataNascimento,
        ...
        if (tipoSanguineo == null) throw new NullPointerException("tipoSanguineo não pode ser nulo");
        this.tipoSanguineo = tipoSanguineo;
        this.convenio = convenio; // convenio pode ser nulo
        if (cpf == null) throw new NullPointerException("cpf não pode ser nulo");
        this.cpf = cpf;
        if (this.cpf.trim().isEmpty()) throw new IllegalArgumentException("cpf inválido");
    }
