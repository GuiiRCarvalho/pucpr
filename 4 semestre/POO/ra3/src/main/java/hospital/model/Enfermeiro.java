...
public class Enfermeiro extends Funcionario {
    ...
    public Enfermeiro(String nome, String endereco, LocalDate dataNascimento,
        ...
        if (coren == null) throw new NullPointerException("coren não pode ser nulo");
        this.coren = coren;
        if (this.coren.trim().isEmpty()) throw new IllegalArgumentException("coren inválido");
        if (turno == null) throw new NullPointerException("turno não pode ser nulo");
        this.turno = turno;
        if (this.turno.trim().isEmpty()) throw new IllegalArgumentException("turno inválido");
    ...
    public void setCoren(String coren) { if (coren == null) throw new NullPointerException("coren não pode ser nulo"); this.coren = coren; }

    public String getTurno() { return turno; }
    public void setTurno(String turno) { if (turno == null) throw new NullPointerException("turno não pode ser nulo"); this.turno = turno; }

    public int getNivel() { return nivel; }
    public void setNivel(int nivel) { if (nivel < 0) throw new IllegalArgumentException("nivel inválido"); this.nivel = nivel; }
