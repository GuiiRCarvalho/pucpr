...
public class Consulta implements Pagavel, Serializable {
    ...
    public Consulta(LocalDateTime dataHora, double valor, String nomePaciente, String nomeMedico) {
        if (dataHora == null) throw new NullPointerException("dataHora não pode ser nulo");
        if (valor < 0) throw new IllegalArgumentException("valor não pode ser negativo");
        if (nomePaciente == null || nomePaciente.trim().isEmpty()) throw new IllegalArgumentException("nomePaciente inválido");
        if (nomeMedico == null || nomeMedico.trim().isEmpty()) throw new IllegalArgumentException("nomeMedico inválido");
    ...
    public String gerarFatura() {
        if (nomePaciente == null || nomePaciente.trim().isEmpty()) throw new IllegalStateException("nomePaciente não definido");
    ...
    public String emitirRecibo() {
        if (dataHora == null) throw new IllegalStateException("dataHora não está definida");
    ...
    public void setDataHora(LocalDateTime dataHora) { if (dataHora == null) throw new NullPointerException("dataHora não pode ser nulo"); this.dataHora = dataHora; }
    ...
    public void setDesconto(double desconto) {
        if (desconto < 0 || desconto > 100) throw new IllegalArgumentException("desconto deve estar entre 0 e 100");
